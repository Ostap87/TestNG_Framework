...
//Created 3 different classes:
	protected ExtentReports report; // actual report
	protected ExtentHtmlReporter htmlReporter; //takes everything and build html page
	protected ExtentTest extentLogger; //takes notes and writes to the report
